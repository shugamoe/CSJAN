        ...
        for item_number in range(len(self.browser.find_element_by_id('courseMenuPalette_contents').find_elements_by_tag_name('li'))):
            ...
            if item.text == 'Send Email':
                ...
                for student_web_element in list_of_students_web_elements:
                    if student_web_element.text == 'Nikolaev, Valeri':
                        print(student_web_element.text)
                #     if student_web_element.text != professor and student_web_element.text not in list_of_tas and 'PreviewUser' not in student_web_element.text:
